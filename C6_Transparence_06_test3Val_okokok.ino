...
const int triggerCompteAReboursPin = 11;  // Broche d'entrée pour le déclenchement du compte à rebours
...
float SeuilSensorOpaqueB = 12; // Seuil pour définir quand le disque est opaque
